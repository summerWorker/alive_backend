...
INSERT INTO `goal` VALUES (1,_binary '>�K(\"�M�\�','step_goal',20000,NULL,NULL),(1,_binary 'M(���Ou\�','bedtime_goal',NULL,NULL,'22:00'),(1,_binary 'b�86G}�F\�','sleep_length_goal',482,NULL,NULL),(1,_binary 'hLs�iMm�0\�','weight_goal',50,'2023-07-20',NULL),(1,_binary '�mT�hEL�\�','calorie_goal',20000,NULL,NULL);
...
INSERT INTO `height` VALUES (1,_binary 'W��d��',1.78,'2023-07-08'),(1,_binary 'W����\�',1.72,'2022-07-08'),(1,_binary '���)�L\�',1.79,'2023-07-10');
...
INSERT INTO `steps` VALUES (_binary 't��_H9�\�',153,'2023-07-01',4,0,15955,1),(_binary 'w#��bALC�\�',153,'2023-07-05',4,2000,15955,1),(_binary 'z��� M�',153,'2023-07-09',4,2000,15955,1),(_binary '�F�rI�\�',153,'2023-07-11',4,10000,2530,1),(_binary '��Ł�Mv\�',153,'2023-04-01',4,10000,2530,1);
...
INSERT INTO `weight` VALUES (1,57.2,'2023-02-22',_binary '\04I$�&F�e \�',0),(1,57.2,'2023-07-12',_binary '%�|�&�Fj\�',50),(1,57.2,'2023-04-22',_binary 'q�y��BIT\�',0),(1,57.2,'2023-07-22',_binary '�0�7�}Iī\�',50),(1,57.2,'2023-06-22',_binary '�h^�0 B�',0),(1,57.2,'2023-07-10',_binary '���RE�',-1);
